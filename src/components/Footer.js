      ...
      <div className='container'>
        <div className='footcart'>
          <div className='foot'>
            ...
            <div className='cailling'><img src='./images/calling.png' alt='call'></img><span>(316) 555-0116</span></div>
          ...
          <div className='foot'>
            ...
            <div className="finputicon">
              ...
              <img src="./images/arrow-right.png" alt="arrow-right" className="icon-right" />
            </div>
          </div>
        </div>
        <hr className='fhr' />
