...
export default function Register({ onClose, onRegisterSuccess }) {
  ...
  const handleRegister = (e) => {
    ...
    console.log("onRegisterSuccess:", onRegisterSuccess); // Bu satır fonksiyonun var olup olmadığını kontrol eder
    if (typeof onRegisterSuccess === "function") {
      console.log("onRegisterSuccess is a function and will be called");
      onRegisterSuccess();
    } else {
      console.error("onRegisterSuccess is not a function or is undefined");
    }
  };
